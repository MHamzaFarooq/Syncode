...
import { SelectCourseBox } from "../Record/select-course";
import AuthInputField from "../Auth/inputfield";
import BorderButton from "../Button/borderButton";
import { useTeacherCourses } from "@/context/TeacherCourses";

const AddAssignmentModal = ({ createAssignment, createAssignmentLoading }) => {
  const {
    data,
    isLoading,
    isError,
  ...
  const disabled = createAssignmentLoading || title === "" || value === "";
        ...
        <DialogHeader>
          ...
          <div className="p-9">
            ...
            <BorderButton
              ...
              disabled={disabled}
              isLoading={createAssignmentLoading}
              type="button"
              loaderColor="#000"
              label={"Add"}
              parentClass={"w-full"}
